--[[
* Addon - Copyright (c) 2023 Halvaard, Halvaard42
* Contact: https://www.twitter.com/that_hal_guy
* Contact: https://github.com/Halvaard/ExpOClock/issues
*
* This file is an addon for Ashita v4.
* It shares the lisenceing structure and scope of the software it is ment to be run by.
*
...
addon.name      = 'ExpOClock';
addon.author    = 'Halvaard';
addon.version   = '0.1';
addon.desc      = 'A clock to help schedule play time in FFXI, showing the time in hours and minutes until the next "Limited time RoE: Gain Exp" event.';
addon.link      = 'https://github.com/Halvaard/ExpOClock/';

--[[get local.time
* get local.day

* convert local.time.day to UTC.day
* compare UTC.day to RoE.schedule
